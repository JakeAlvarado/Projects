...
class AlienInvasion:
    ...
    def __init__(self):
    #Intialize the game, create game resources.
        pygame.init()
    ...
    def _check_bullet_alien_collisions(self):
        # Check for bullet collisions and get rid of bullet and alien
    ...
    def _create_fleet(self):
        ...
        # Find the spacing between each alien (equal to one alien width)
        ...
        #Create the fullet fleet of aliens
